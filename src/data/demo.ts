  ...
  return [
    {
      ...
      nikki_message: "It is time for your morning medication. Please take the two pills from the blue box with a glass of water.",
      instructions: "Two pills from the blue box, with water.",
